...
This sample uses one side-view black Labrador pixel-art reference with a red
collar on a flat green chroma-key background.

## Files

- `source_imagegen.png` — original generated source image
